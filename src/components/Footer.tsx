  ...
  return (
    <footer className="mt-10 bg-black pb-24 text-sm text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-3">
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-white/50">
            Mit der Anmeldung willigst du ein, Werbe-E-Mails von {company.tradingName} zu erhalten. Du kannst dich jederzeit abmelden. Siehe unsere{" "}
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 border-t border-white/10 px-4 py-6 text-xs text-white/60 md:flex-row md:justify-between">
        ...
        <div>
          {footer.copyright} · {footer.reseller} · {company.registerNumber}
        </div>
      </div>
    </footer>
  );
